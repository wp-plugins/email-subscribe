...
Wp Email Subscription is plugin that can be use as newsletter subscription.This is very easy to use plugin.Just set how many times newsletter modal appear when user enter to site.admin can
also use this plugin as widget.Admin can also set link for newsletter signup.When click on link the modal popup of newsletter signup will appear.This plugin provide full customization of each and every lables
messages and error messages.This plugin can be used for any website localization. 
...
1. Mass email to subscribers.

2. Import subscribers.

3. Export subscribers.

4. Mass delete subscribers.

5. Newsletter email templates.

6. unsubscribe from newsletter.

7. Username,email,unsubscribe link place holders while sending emails.

8. Search subscribers.

9. View unsubscribers list and take action of resubscribe or delete it.
...
4. Widget preview.
5. Pro version features like mass email,import/export,delete subscribers
6. List of unsubscribers
7. Manage newsletter templates
8. Mass email preview
